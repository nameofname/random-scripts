...
training_csv = training_data['Training Sentence'].to_csv(index = False, header = False)
training_string = '\n'.join(training_list)
...
f = open("training_output/paraphrase_training_data_{}_{}_{}.csv".format(t.month, t.day, t.year), "w")
f.write(training_csv)
